...
const fallbackArticles: ArticleData[] = [
  {
    ...
    body: [
      ...
      "CergyPro brings deep expertise at the intersection of aerospace operations and enterprise technology platforms. Our approach to SLA management starts with understanding the contractual landscape — mapping every obligation, dependency, and escalation path — before configuring technology solutions. We then design ServiceNow workflows that mirror the operational reality of aerospace programs, integrating with existing ERP, MRO, and supply chain systems to create end-to-end visibility. For organizations ready to move beyond reactive SLA tracking, we deploy AI models that continuously assess risk across the supplier network and recommend preemptive actions. The result is a shift from managing SLA failures to preventing them — an approach that protects margins, strengthens customer relationships, and ensures mission readiness in an industry where there is no margin for error.",
    ],
  },
  {
