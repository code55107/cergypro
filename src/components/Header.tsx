            ...
            <nav className="flex flex-col px-6 py-4" aria-label="Mobile navigation">
                    ...
                    {item.hasDropdown && menu && (
                      ...
                      >
                        <div className="pl-2 py-3 space-y-4">
                          {menu.columns.map((col) => (
                            <div key={col.heading}>
                              <span className="block text-[10px] font-bold tracking-[0.15em] uppercase text-gray-500 mb-2">
                                {col.heading}
                              </span>
                              {col.items.map((link) => (
                                <Link
                                ...
                                >
                                  <CapIcon label={link.label} />
                                  <div>
                                    <span className="block text-xs text-gray-300 hover:text-white transition-colors">
                                      {link.label}
                                    </span>
                                    {link.desc && (
                          ...
                          {menu.featured && (
                            ...
                            >
                              <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-accent-cyan block mb-1">
                                {menu.featured.tag}
                              </span>
                          ...
                          <Link
                            href={menu.viewAllHref}
                            onClick={closeMobile}
                            className="inline-flex items-center gap-1 text-[11px] font-semibold tracking-wider uppercase text-accent-cyan pl-2 pt-1"
                          >
                            {menu.viewAllLabel}
                            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              ...
              >
                <Link
                  href="/contact"
                  onClick={closeMobile}
                  className="flex items-center justify-center gap-2 w-full py-3 text-xs font-semibold tracking-wider uppercase border border-white/20 text-white hover:bg-white hover:text-black transition-all"
                >
                  Contact Us
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
