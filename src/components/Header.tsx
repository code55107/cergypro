    ...
    columns: [
      {
        heading: "Topics",
        items: [
          { label: "AI & Technology", href: "/insights", desc: "GenAI, ML & emerging tech trends" },
          { label: "Digital Transformation", href: "/insights", desc: "Strategy, platforms & modernization" },
          { label: "Cybersecurity", href: "/insights", desc: "Threats, compliance & zero trust" },
          { label: "ServiceNow", href: "/insights", desc: "Platform insights & best practices" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Client Stories", href: "/insights", desc: "Real-world transformation impact" },
          { label: "Research & Reports", href: "/insights", desc: "Industry analysis & benchmarks" },
          { label: "Webinars & Events", href: "/insights", desc: "On-demand & upcoming sessions" },
          { label: "News & Press", href: "/insights", desc: "Company announcements" },
        ],
      },
      {
        heading: "Trending",
        items: [
          { label: "Now Assist & GenAI in ITSM", href: "/insights", desc: "The future of service delivery" },
          { label: "Zero Trust for Federal", href: "/insights", desc: "CMMC & FedRAMP readiness" },
          { label: "AI Governance Frameworks", href: "/insights", desc: "Responsible AI at enterprise scale" },
        ],
      },
    ],
    featured: {
      tag: "LATEST PERSPECTIVE",
      title: "Why ServiceNow Is Becoming the Enterprise AI Platform",
      desc: "How Now Assist and domain-specific LLMs are reshaping IT, HR, and customer workflows across the Fortune 500.",
      href: "/insights",
    ...
    columns: [
      {
        heading: "Company",
        items: [
          { label: "Our Mission", href: "/about", desc: "Technology that moves missions forward" },
          { label: "Leadership", href: "/about", desc: "Our executive team & advisors" },
          { label: "Values & Culture", href: "/about", desc: "How we work and what we stand for" },
          { label: "History", href: "/about", desc: "From startup to global consultancy" },
          { label: "Corporate Responsibility", href: "/about", desc: "Community & sustainability" },
        ],
      },
      {
        heading: "Careers",
